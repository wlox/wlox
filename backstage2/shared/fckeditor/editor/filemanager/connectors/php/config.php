...
if (!empty($_COOKIE['fckdirabs'])){
	$Config['UserFilesPath'] = $_COOKIE['fckdirabs'];
}else{
	$Config['UserFilesPath'] = '/userfiles/'; //only needed for config file to continue working.
}
...
if (!empty($_COOKIE['fckdir'])){
	$Config['UserFilesAbsolutePath'] = $_COOKIE['fckdir'];
}else {
