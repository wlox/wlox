...
if ($delete_id1 > 0) {
	$del_order = DB::getRecord('orders',$delete_id1,0,1);
...
$bids = Orders::get(false,false,false,$currency1,User::$info['id'],false,$CFG->order_type_bid,$order_by1,false,1);
$asks = Orders::get(false,false,false,$currency1,User::$info['id'],false,$CFG->order_type_ask,$order_by1,1,1);
...
<div class="page_title">
	<div class="container">
        ...
        <div class="pagenation">&nbsp;<a href="index.html"><?= Lang::string('home') ?></a> <i>/</i> <a href="account.php"><?= Lang::string('account') ?></a> <i>/</i> <a href="open-orders.php"><?= $page_title ?></a></div>
	</div>
</div>
<div class="container">
