...
$total = News::get(1);
$news = News::get(false,$page1,10);
$pagination = Transactions::pagination('news.php',$page1,$total,10,5,$CFG->pagination_label);
...
<div class="page_title">
	<div class="container">
        ...
        <div class="pagenation">&nbsp;<a href="index.html"><?= Lang::string('home') ?></a> <i>/</i> <a href="news.php"><?= $page_title ?></a></div>
	</div>
</div>
<div class="container">
