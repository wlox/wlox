...
$total = Transactions::get(1,$page1,30,$currency1,User::$info['id'],$start_date1,$type1,$order_by1,$order_desc1);
$transactions = Transactions::get(false,$page1,30,$currency1,User::$info['id'],$start_date1,$type1,$order_by1,$order_desc1);
$pagination = Transactions::pagination('transactions.php',$page1,$total,30,5,$CFG->pagination_label);
$transaction_types = Transactions::getTypes();
