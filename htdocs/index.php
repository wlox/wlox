...
if (!User::isLoggedIn()) {
	$content = Content::getRecord('home');
	$feature1 = Content::getRecord('home-feature1');
	$feature2 = Content::getRecord('home-feature2');
	$feature3 = Content::getRecord('home-feature3');
	$feature4 = Content::getRecord('home-feature4');
}
...
$transactions = Transactions::get(false,false,5,$currency1,false,false,$CFG->transactions_buy_id);
$bids = Orders::get(false,false,5,$currency1,false,false,$CFG->order_type_bid);
$asks = Orders::get(false,false,5,$currency1,false,false,$CFG->order_type_ask,false,1);
$currencies = $CFG->currencies;
$news = News::get(false,false,3);
